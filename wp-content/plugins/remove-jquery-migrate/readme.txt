...
Removes the jQuery Migrate script from the front end of your site.

== Description ==

This plugin removes the jQuery Migrate script (jquery-migrate.js or jquery-migrate.min.js) from the [front end](https://wordpress.org/support/article/glossary/#front-end) of your site.
...
Read more [here](https://www.thewebflash.com/remove-jquery-migrate-from-the-front-end-of-your-wordpress-site/).
